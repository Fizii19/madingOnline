...
class DashboardController extends Controller
{
    public function index(): View
    {
        ...
        $stats = [
            ...
            ['label' => 'MENUNGGU PERSETUJUAN', 'value' => number_format($pendingPosts), 'accent' => 'bg-accent-orange', 'note' => 'Tinjau Sekarang', 'icon' => 'hourglass_top', 'color' => 'text-accent-orange', 'link' => route('management')],
        ];
